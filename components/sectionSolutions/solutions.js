    ...
    return (
        <>
            <section id="solutions" className="text-gray-600 body-font">
                ...
                <a class="font-NotoSans sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium bg-gray-100 inline-flex items-center leading-none border-indigo-500 text-indigo-500 tracking-wider rounded-t"
                    onClick={() => 
                      {
                        setSolution("deploy");
                      }
                ...
                <a class="font-NotoSans sm:px-6 py-3 w-1/2 sm:w-auto justify-center sm:justify-start border-b-2 title-font font-medium inline-flex items-center leading-none border-gray-200 hover:text-gray-900 tracking-wider"
                    onClick={() => 
                      {
                        setSolution("promote");
                      }
                ...
                {/* <img class="xl:w-1/4 lg:w-1/3 md:w-1/2 w-2/3 block mx-auto mb-10 object-cover object-center rounded" alt="hero" src="https://dummyimage.com/720x600"></img> */}
                <div class="flex flex-col text-center w-full">
                <h1 class="font-NotoSansBold  text-xl font-medium title-font mb-4 text-gray-900">{title}</h1>
                <p class="font-NotoSans text-center lg:w-1/4  mx-auto leading-relaxed">{description}</p>
                </div>
            </div>
            </section>
        </>
