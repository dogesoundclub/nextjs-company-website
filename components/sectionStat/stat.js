            ...
            <section className="text-gray-600">
                <div className="container px-5 py-24 mx-auto flex flex-wrap justify-center">
                    ...
                    <div className="w-full sm:p-4 px-4 mb-6">
                        <h1 className="font-BrothersBold sm:text-3xl text-2xl  mb-4 text-gray-200">STAT</h1>
                    ...
                    <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
                        <h2 className=" text-3xl text-gray-200">$3M</h2>
                        <p className="leading-relaxed">Trading Volume</p>
                    </div>
                    <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
                        <h2 className=" text-3xl text-gray-200">12K</h2>
                        <p className="leading-relaxed">Holder Wallets</p>
                    </div>
                    <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
                        <h2 className=" text-3xl text-gray-200">21K</h2>
                        <p className="leading-relaxed">Followers</p>
                    </div>
                    <div className="p-4 sm:w-1/2 lg:w-1/4 w-1/2">
                        <h2 className=" text-3xl text-gray-200">10+</h2>
